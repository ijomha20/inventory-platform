...
// =============================================================================
// DAILY BACKUP (run from menu or add a daily trigger)
// =============================================================================
...
// -----------------------------------------------------------------------------
// doGetInventory
// Returns all rows where col H (Notes/Your Cost) is filled.
// Fields included:
//   location    -- col A  (location code, e.g. "MM")
//   vehicle     -- col C + D  (Year/Make + Model)
//   vin         -- col B
//   matrixPrice -- col F  (Matrix list price; owner-only in the portal)
//   cost        -- col G  (Your acquisition cost; owner-only in the portal)
//   price       -- col H  (Your selling price / Notes -- gates visibility)
//   km          -- col E  (mileage)
//   carfax      -- col J
//   website     -- col K
//   onlinePrice -- col L
